...
> позволяет пользователю решать задачи на определение вероятности наступления события при определенном количестве наблюдений с использованием формулы Бернулли и биномиального коэффициента, запрашивая необходимые данные у пользователя и выводя результат вычислений
