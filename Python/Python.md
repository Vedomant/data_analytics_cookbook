...
`Дисперсия:  10`
> переменная data должна содержать числовые данные: в частности, переменная data может содержать список, кортеж или другую коллекцию числовых значений

###### Среднеквадратическое отклонение

`data = [1, 5, 2, 7, 1, 9, 3, 8, 5, 9]`<br>
`print("Среднеквадратическое отклонение: ", statistics.stdev(data))`<br>
`Среднеквадратическое отклонение:  3.1622776601683795`
> data должна содержать список, кортеж, массив или другую коллекцию числовых значений
