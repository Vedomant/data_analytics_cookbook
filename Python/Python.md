...
`df[df['price']>500]`
> иной способ фильтрации: выводит строки датасета, где значение столбца "price" больше 500

`df[~(df['price']>500)]`
> иной способ фильтрации: выводит строки датасета, где значение столбца "price" меньше 500
...
> иной способ фильтрации: выводит строки датасета, где значение столбца "price" между 10 и 20 (включительно)<br>
